    ...
    return (
        <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
            <div className="container nav-content">
                <a href="/" className="brand-logo-nav" style={{ textDecoration: 'none' }}>
                    {/* Logo Image */}
                ...
                <ul className={`nav-links ${mobileOpen ? 'open' : ''}`}>
                    ...
                    <li><a href="/valores" onClick={() => setMobileOpen(false)}>Valores</a></li>
                    <li><a href="/tienda" onClick={() => setMobileOpen(false)}>Tienda</a></li>
                    ...
                    <li>
                        <a href="/checkout" className="cart-icon-btn" aria-label="Ver Carrito" onClick={() => setMobileOpen(false)}>
